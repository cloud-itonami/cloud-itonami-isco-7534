...
`cloud-itonami-isco-7534` is an OSS open-occupation blueprint. Governance covers
...
- Upholstery Coordination Governor remains independent of the advisor.
- hard policy violations cannot be overridden by human approval.
- an upholstery-execution decision, a workshop-safety-clearance
  decision, and any override of a shop safety officer's judgment,
  stay permanently outside this actor's op-allowlist.
- every commit, hold and approval path is auditable.
- real upholsterer/workshop/operator data stays outside Git.
...
- mishandling upholsterer/workshop/operator data
- misrepresenting certification status
- failing to respond to security incidents
- hiding material changes to customer-facing operation
- attempting to route an upholstery-execution decision, a
