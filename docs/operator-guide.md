...
2. Define consent and purpose categories for upholsterer/workshop records.
...
- provenance for all operating records (upholsterer and workshop both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route an
  upholstery-execution decision or a workshop-safety-clearance
...
upholstery-execution decision, a workshop-safety-clearance decision,
